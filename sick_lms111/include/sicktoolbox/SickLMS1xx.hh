...
namespace SickToolbox {
  ...
  private:
    ...
    void _SplitReceivedMessage(SickLMS1xxMessage recv_message);
    int  _ConvertHexToDec(std::string num);//字符串转带符号十进制
    unsigned int _ConvertHexToUInt(std::string num);//字符串转无符号十进制
  };
